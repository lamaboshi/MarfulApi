...
namespace MarfulApi.Data
{
    public class MarfulDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Company>().HasData(new Company { Id = 10, Name = "REEBOK", Description = "It is an American company that manufactures footwear and sportswear and is part of the Authentic Brands Group", Address = "Reebok International Limited (/ˈriːbɒk/) is an American fitness footwear and clothing manufacturer that is a part of Authentic Brands Group.", Email = "REEBOK@test.com", Phone = "0921423432", TelePhone = "223554", Password = "111222" });
            ...
            modelBuilder.Entity<Product>().HasData(new Product { Id = 46, Name = "T Shirt", Price = 800, Description = "This some Text about found", BrandId = 15, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 47, Name = "Pants", Price = 1000, Description = "This some Text about found", BrandId = 15, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 48, Name = "Jacket", Price = 1100, Description = "This some Text about found", BrandId = 15, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 49, Name = "Fried", Price = 100, Description = "This some Text about found", BrandId = 16, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 50, Name = "Sandwich", Price = 800, Description = "This some Text about found", BrandId = 16, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 51, Name = "Fried chicken", Price = 1000, Description = "This some Text about found", BrandId = 16, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 52, Name = "Fried", Price = 100, Description = "This some Text about found", BrandId = 17, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 53, Name = "Sandwich", Price = 800, Description = "This some Text about found", BrandId = 17, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 54, Name = "Fried chicken", Price = 1000, Description = "This some Text about found", BrandId = 17, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 55, Name = "Melo", Price = 500, Description = "This some Text about found", BrandId = 18, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 56, Name = "3 in 1", Price = 400, Description = "This some Text about found", BrandId = 18, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 57, Name = "Biscuits", Price = 200, Description = "This some Text about found", BrandId = 18, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 58, Name = "Milk Shake", Price = 500, Description = "This some Text about found", BrandId = 19, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 59, Name = "Coffie", Price = 400, Description = "This some Text about found", BrandId = 19, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 60, Name = "Pizza Mushroom", Price = 1000, Description = "This some Text about found", BrandId = 20, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 61, Name = "Pizza 4 seasons", Price = 1200, Description = "This some Text about found", BrandId = 20, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 62, Name = "Mobile", Price = 5000, Description = "This some Text about found", BrandId = 21, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 63, Name = "Labtop", Price = 8000, Description = "This some Text about found", BrandId = 21, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 64, Name = "Mobile", Price = 5000, Description = "This some Text about found", BrandId = 22, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 65, Name = "Labtop", Price = 8000, Description = "This some Text about found", BrandId = 22, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 66, Name = "Washing Machine", Price = 9000, Description = "This some Text about found", BrandId = 23, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 67, Name = "TV", Price = 6500, Description = "This some Text about found", BrandId = 23, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 68, Name = "Game Og Throns", Price = 200, Description = "This some Text about found", BrandId = 24, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 69, Name = "Friends", Price = 200, Description = "This some Text about found", BrandId = 24, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 70, Name = "باب  الحارة", Price = 200, Description = "This some Text about found", BrandId = 25, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 71, Name = "الهيبة", Price = 200, Description = "This some Text about found", BrandId = 25, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 72, Name = "Dior", Price = 900, Description = "This some Text about found", BrandId = 26, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 73, Name = "Channel", Price = 900, Description = "This some Text about found", BrandId = 27, Code = "55555" });
            modelBuilder.Entity<Product>().HasData(new Product { Id = 74, Name = "Gucci", Price = 900, Description = "This some Text about found", BrandId = 28, Code = "55555" });
