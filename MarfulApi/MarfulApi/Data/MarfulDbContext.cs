...
namespace MarfulApi.Data
{
    public class MarfulDbContext: DbContext
    {
        ...
        {
            modelBuilder.Entity<Company>().HasData(new Company { Id=1,Name= "JUICY BEAUTY",Description= "MakeUp For Weman",Address="From Streat",Email="Test@test.com",Phone="0921423432",TelePhone="4232543" });
